...
export default function ArticleDetail() {
  ...
  const getArticleData = (id: string | undefined) => {
    ...
    if (id === 'cara-cepat-approve-di-adobe-stock') {
      return {
        ...defaultData!,
        htmlContent: `
          <p>&nbsp;</p><h1 data-path-to-node="3">Cara Cepat Approve di Adobe Stock: Panduan Strategi Stok Asset Vector untuk Pemula</h1><div class="separator" style="clear: both; text-align: center;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiz_X2b7xgyWeqLvQIZ8m-MuzMAY96tgnnvwtFz9BlC2TlqKaSYS0I_osMqNn31lqwVK4wVcq9B6Yg8sumD2SDn80skieVp7MsCX3A0wb8magahP6N8XEe4M9KXEg0DM5rE4s3cmghYNgCvIergUhMDSEt1ZOohcjizL9I_HkmPOlP8fvNELM0CNhDfdbM/s1536/ChatGPT%20Image%20May%207,%202026,%2009_50_17%20PM.png" imageanchor="1" style="margin-left: 1em; margin-right: 1em;"><img border="0" data-original-height="1024" data-original-width="1536" height="426" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiz_X2b7xgyWeqLvQIZ8m-MuzMAY96tgnnvwtFz9BlC2TlqKaSYS0I_osMqNn31lqwVK4wVcq9B6Yg8sumD2SDn80skieVp7MsCX3A0wb8magahP6N8XEe4M9KXEg0DM5rE4s3cmghYNgCvIergUhMDSEt1ZOohcjizL9I_HkmPOlP8fvNELM0CNhDfdbM/w640-h426/ChatGPT%20Image%20May%207,%202026,%2009_50_17%20PM.png" width="640" /></a></div><br /><p data-path-to-node="4"><br /></p><p data-path-to-node="4">Bagi kontributor <i data-index-in-node="17" data-path-to-node="4">microstock</i>, tantangan terbesar bukan hanya soal membuat gambar yang bagus, tapi bagaimana agar aset tersebut <b data-index-in-node="126" data-path-to-node="4">cepat di-approve</b> dan <b data-index-in-node="147" data-path-to-node="4">efisien saat diproduksi</b>. Menunggu proses kurasi Adobe Stock yang ketat seringkali memakan waktu jika kita tidak paham standar teknisnya.</p><p data-path-to-node="5">Jika Anda ingin meningkatkan <i data-index-in-node="29" data-path-to-node="5">approval rate</i> sekaligus memperbanyak jumlah portofolio tanpa harus lembur setiap hari, simak panduan dan workflow efisien berikut ini.</p><h2 data-path-to-node="7">Standar Wajib Agar Vector Cepat Di-Approve</h2><p data-path-to-node="8">Reviewer Adobe Stock bekerja dengan standar kualitas tinggi. Pastikan aset Anda lolos pengecekan dasar ini:</p><ol data-path-to-node="9" start="1"><li><p data-path-to-node="9,0,0"><b data-index-in-node="0" data-path-to-node="9,0,0">Format EPS 10 &amp; Kompatibilitas:</b> Selalu simpan file dalam format EPS 10. Ini adalah format paling "aman" dan kompatibel untuk semua software desain.</p></li><li><p data-path-to-node="9,1,0"><b data-index-in-node="0" data-path-to-node="9,1,0">Kebersihan File (Housekeeping):</b> Gunakan fitur <i data-index-in-node="46" data-path-to-node="9,1,0">Action</i> di Illustrator untuk menghapus <i data-index-in-node="84" data-path-to-node="9,1,0">stray points</i>, <i data-index-in-node="98" data-path-to-node="9,1,0">unpainted objects</i>, dan pastikan tidak ada <i data-index-in-node="140" data-path-to-node="9,1,0">hidden layers</i>. File yang berantakan adalah alasan nomor satu penolakan teknis.</p></li><li><p data-path-to-node="9,2,0"><b data-index-in-node="0" data-path-to-node="9,2,0">No Bitmaps:</b> Pastikan tidak ada efek <i data-index-in-node="36" data-path-to-node="9,2,0">raster</i> seperti <i data-index-in-node="51" data-path-to-node="9,2,0">drop shadow</i> atau <i data-index-in-node="68" data-path-to-node="9,2,0">blur</i> yang belum di-expand. Semua elemen harus murni berbasis vector.</p></li><li><p data-path-to-node="9,3,0"><b data-index-in-node="0" data-path-to-node="9,3,0">Metadata yang Relevan:</b> Masukkan 5-10 kata kunci utama di urutan teratas. Adobe Stock sangat mengandalkan relevansi kata kunci untuk proses kurasi otomatis mereka.</p></li></ol><h2 data-path-to-node="11">Workflow "Jalan Pintas" Menggunakan AI</h2><p data-path-to-node="12">Membuat setiap garis secara manual tentu memakan waktu lama. Untuk mempercepat "nyetok", Anda bisa mengintegrasikan AI ke dalam <i data-index-in-node="128" data-path-to-node="12">lineup</i> produksi Anda. Berikut adalah alur kerjanya:</p><h3 data-path-to-node="13">Lineup Produksi Vector AI:</h3><ol data-path-to-node="14" start="1"><li><p data-path-to-node="14,0,0"><b data-index-in-node="0" data-path-to-node="14,0,0">Generasi Ide &amp; Image:</b> Gunakan AI (seperti Midjourney atau Adobe Firefly) untuk menghasilkan gambar dasar. Gunakan prompt spesifik seperti <i data-index-in-node="138" data-path-to-node="14,0,0">"flat illustration, hand drawn style, isolated on white background"</i>.</p></li><li><p data-path-to-node="14,1,0"><b data-index-in-node="0" data-path-to-node="14,1,0">Vectorizing (Tracing):</b> Masukkan hasil AI ke Adobe Illustrator. Gunakan fitur <i data-index-in-node="77" data-path-to-node="14,1,0">Image Trace</i> dengan settingan yang sudah dioptimasi agar jumlah <i data-index-in-node="140" data-path-to-node="14,1,0">anchor point</i> tidak terlalu banyak.</p></li><li><p data-path-to-node="14,2,0"><b data-index-in-node="0" data-path-to-node="14,2,0">Simplifikasi:</b> Gunakan tools <code data-index-in-node="28" data-path-to-node="14,2,0">Object &gt; Path &gt; Simplify</code> untuk merapikan garis agar terlihat lebih natural dan ringan.</p></li><li><p data-path-to-node="14,3,0"><b data-index-in-node="0" data-path-to-node="14,3,0">Finishing:</b> Berikan sentuhan manual pada warna atau detail kecil agar aset memiliki ciri khas unik dan tidak terlihat "mentah" dari AI.</p></li></ol><h2 data-path-to-node="16">Bingung Cara Memulai? Gunakan Workflow yang Sudah Terbukti!</h2><p data-path-to-node="17">Mengetahui tips di atas hanyalah langkah awal. Tantangan sebenarnya adalah bagaimana membangun <b data-index-in-node="95" data-path-to-node="17">sistem kerja (workflow)</b> yang konsisten sehingga Anda bisa menyetok puluhan bahkan ratusan aset berkualitas setiap minggunya tanpa rasa lelah.</p><p data-path-to-node="18">Jika Anda tidak mau repot melakukan <i data-index-in-node="36" data-path-to-node="18">trial and error</i> sendiri dalam mencari cara nyetok yang efektif, saya sudah merangkumnya untuk Anda.</p><p data-path-to-node="19">Perkenalkan: <b data-index-in-node="13" data-path-to-node="19">Flat Vector Hand Drawn</b> – Sebuah panduan dan workflow komprehensif yang dirancang khusus untuk membantu Anda menguasai cara menyetok aset vector dengan gaya <i data-index-in-node="169" data-path-to-node="19">hand-drawn</i> yang sangat diminati pasar saat ini.</p><p data-path-to-node="20">Dalam workflow ini, Anda akan belajar:</p><ul data-path-to-node="21"><li><p data-path-to-node="21,0,0">Cara memproduksi aset vector dengan cepat namun tetap terlihat personal (sentuhan tangan).</p></li><li><p data-path-to-node="21,1,0">Sistem manajemen aset agar proses upload ke Adobe Stock menjadi lebih sistematis.</p></li><li><p data-path-to-node="21,2,0">Trik rahasia agar produksi gambar Anda selalu memenuhi standar pasar internasional.</p></li></ul><p data-path-to-node="22">Jangan buang waktu dengan cara manual yang melelahkan. Bangun aset digital Anda dengan sistem yang benar sekarang juga!</p><p data-path-to-node="23">👉 <b data-index-in-node="3" data-path-to-node="23"><a class="ng-star-inserted" data-hveid="0" data-ved="0CAAQ_4QMahcKEwjQlPbIrKeUAxUAAAAAHQAAAAAQPw" decode-data-ved="1" externallink="" href="https://clicky.id/digitalbareng/flat-vector-hand-drawn" jslog="197247;track:generic_click,impression,attention;BardVeMetadataKey:[[&quot;r_7d6e5425f1d03182&quot;,&quot;c_b6ac0d86043fa9b1&quot;,null,&quot;rc_bc45ddfd0a8c79b4&quot;,null,null,&quot;id&quot;,null,1,null,null,1,0]]" rel="noopener" target="_blank">Pelajari Workflow Flat Vector Hand Drawn di Sini</a></b></p>
        `
      };
    }
