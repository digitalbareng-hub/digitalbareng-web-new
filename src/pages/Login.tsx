...
import { Globe, LogIn, Mail, Lock, Loader2, ArrowLeft } from 'lucide-react';
    ...
    try {
      ...
      if (err instanceof FirebaseError) {
        if (err.code === 'auth/invalid-credential') {
          ...
          setError('Metode login dengan email/password belum diaktifkan di Firebase. Silakan aktifkan di Firebase Console.');
        } else {
