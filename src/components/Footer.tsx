        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 opacity-80 mb-4">
              <div className="w-8 h-8 rounded overflow-hidden flex items-center justify-center bg-blue-50">
              ...
              <span className="font-bold text-lg text-slate-900">DigitalBareng</span>
            </div>
