    ...
    <footer className="bg-white border-t border-slate-200 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <Link reloadDocument to="/" className="md:col-span-2 group">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-500">
              <li><Link reloadDocument to="/guide" className="hover:text-orange-600 transition-colors">Start Here (Guide)</Link></li>
              <li><Link reloadDocument to="/blog" className="hover:text-orange-600 transition-colors">Artikel Terbaru</Link></li>
              <li><Link reloadDocument to="/tools" className="hover:text-orange-600 transition-colors">Rekomendasi Tools</Link></li>
              <li><Link reloadDocument to="/contact" className="hover:text-orange-600 transition-colors">Kontak</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="font-semibold mb-4 text-slate-900">Legal</h4>
            <ul className="space-y-2 text-sm text-slate-500">
              <li><Link reloadDocument to="/privacy-policy" className="hover:text-orange-600 transition-colors">Privacy Policy</Link></li>
              <li><Link reloadDocument to="/terms-of-use" className="hover:text-orange-600 transition-colors">Terms of Use</Link></li>
            </ul>
          </div>
        </div>
